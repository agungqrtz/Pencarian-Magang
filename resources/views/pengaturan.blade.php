...
<body class="bg-gray-100 font-sans antialiased flex justify-center min-h-screen">
    ...
    <div class="w-full max-w-[420px] bg-white h-full min-h-screen relative shadow-2xl flex flex-col">
        ...
        <div class="bg-[#D9D9D9] pt-12 px-6 pb-6 rounded-b-[30px] flex items-center relative z-10">
            ...
            <h1 class="text-lg font-medium text-black absolute left-1/2 transform -translate-x-1/2">Pengaturan</h1>
        </div>

        <div class="flex-1 px-6 pt-8 pb-32 flex flex-col">
            
            <div class="mb-6">
                <h2 class="text-base font-bold text-black mb-3 ml-1">Akun</h2>
                <div class="space-y-3">
                    <button class="w-full bg-[#D9D9D9] hover:bg-gray-300 transition text-black font-bold text-sm py-3 px-4 rounded-md shadow-sm">
                        Edit Profil
                    </button>
                    <button class="w-full bg-[#D9D9D9] hover:bg-gray-300 transition text-black font-bold text-sm py-3 px-4 rounded-md shadow-sm">
